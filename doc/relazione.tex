...
\begin{tabular}{{l|l|l|l|l|l}}
\toprule
Fornitore & Input & Formati & Caratteristiche & Piano gratuito & Tariffe (dollari/chiamata) \\ \hline
\midrule
% Microsoft                          
...
& jpeg, png, gif, bmp 
& \begin{tabular}{@{}c@{}}
Tagging, Classificazione, OCR, Identificazione colori e B/N,\\
Gen. descrizioni, Contenuti per adulti
\end{tabular}
& 5000 chiamate/mese
& $0,015$, max 10 TPS \\ \hline
% IBM
\multicolumn{1}{l|}{IBM VS}
& raw, URL
& jpeg, png
& Classificazione (anche custom), riconoscimento volti, Collezioni
& \begin{tabular}{@{}c@{}}
7500 immagini/mese\footnote{In realtà il conteggio è giornaliero.}\\
