...
Per quanto concerne il riconoscimento delle immagini, Microsoft offre le \textit{Computer Vision API} \cite{msc-api}, che spaziano dal riconoscimento dei volti all'analisi delle caratteristiche cromatiche dell'immagine.
